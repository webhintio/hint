...
* [[`46c89ce258`](https://github.com/webhintio/hint/commit/46c89ce2583d71277d90b83b89c6c1cc61f13f90)] - Upgrade: Bump postcss from 8.4.4 to 8.4.5 (by [`dependabot[bot]`](https://github.com/apps/dependabot)).
...
* [[`7488e926e0`](https://github.com/webhintio/hint/commit/7488e926e01933959423fe104d11ebdf5211a820)] - Upgrade: Bump postcss from 8.3.11 to 8.4.4 (by [`dependabot[bot]`](https://github.com/apps/dependabot)).
...
* [[`2e5e01584b`](https://github.com/webhintio/hint/commit/2e5e01584b2eb26c2e1078d4d42e0650319892c6)] - Upgrade: Bump postcss from 8.3.5 to 8.3.8 (by [`dependabot[bot]`](https://github.com/apps/dependabot)).
...
* [[`020c09a80f`](https://github.com/webhintio/hint/commit/020c09a80f5771bdb09f632a55bf92b61d3a725b)] - Upgrade: Bump postcss from 8.3.2 to 8.3.5 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`3fd3703a40`](https://github.com/webhintio/hint/commit/3fd3703a409bd83eec16303d928f8c32b24b26b7)] - Fix: Ignore input[inputmode] (by [`Dmitry Kustov`](https://github.com/Simbiat) / see also: [`#4547`](https://github.com/webhintio/hint/issues/4547)).
...
* [[`d7b0aff005`](https://github.com/webhintio/hint/commit/d7b0aff00563041c5dfb50488aebb04e6172f992)] - Upgrade: Bump postcss from 8.2.8 to 8.2.12 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`b5da0eb68b`](https://github.com/webhintio/hint/commit/b5da0eb68b78546bc887103b71db4e295de8335f)] - Upgrade: Bump postcss from 8.2.7 to 8.2.8 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`356fdcf232`](https://github.com/webhintio/hint/commit/356fdcf232e1feed7c10eed156a1a796cfe175ea)] - Upgrade: Bump postcss from 8.2.4 to 8.2.6 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`b68c7c7e2d`](https://github.com/webhintio/hint/commit/b68c7c7e2d99de215ecec6b9413cee7bb02d6426)] - Upgrade: Bump postcss from 8.2.1 to 8.2.4 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`652585cce1`](https://github.com/webhintio/hint/commit/652585cce1279f2361c277774b9a4ee2adf879de)] - Chore: Update compat tests to account for Edge 79+ (by [`Tony Ross`](https://github.com/antross)).
...
* [[`a34443ab4b`](https://github.com/webhintio/hint/commit/a34443ab4ba19a04f7069f3fd9fbaa981a7a773a)] - New: Default severity for `hint-compat-api` (see also: [`#3213`](https://github.com/webhintio/hint/issues/3213)).
...
* [[`ec07d7bad4`](https://github.com/webhintio/hint/commit/ec07d7bad43bb52b8413ef8c077c4d7fee399208)] - Chore: Update packages to use @hint/utils-css.
...
# 4.1.3 (October 16, 2019)

## Chores

* [[`fa357fd1de`](https://github.com/webhintio/hint/commit/fa357fd1ded2fb9648b71afa67b1773865b2cb30)] - Chore: Use new `utils-compat-data` package (by [`Antón Molleda`](https://github.com/molant)).
...
# 4.1.2 (September 26, 2019)


# 4.1.1 (September 24, 2019)
...
* [[`c4e077e3a4`](https://github.com/webhintio/hint/commit/c4e077e3a40729292582ff88d4e418852361220e)] - Fix: Add link[rel=preload] to the default ignore list (by [`Tony Ross`](https://github.com/antross) / see also: [`#2897`](https://github.com/webhintio/hint/issues/2897)).
...
* [[`11c21cda26`](https://github.com/webhintio/hint/commit/11c21cda26a042e09bb2d3a3d0e6cd7ca3725056)] - Fix: Update list of ignored browsers (by [`Tony Ross`](https://github.com/antross)).
* [[`256c1488aa`](https://github.com/webhintio/hint/commit/256c1488aa0a4fb4ffc4534bf8c6b9e37e97df3d)] - Fix: Update default ignore list for CSS and HTML (by [`Tony Ross`](https://github.com/antross)).
* [[`cfc6a086ff`](https://github.com/webhintio/hint/commit/cfc6a086ff3eea00bb6cb5e3b85aa859a9d0b691)] - Docs: Remove references to non-existent `-next` hints (by [`Aki`](https://github.com/gesa)).
* [[`65d2a9a6cc`](https://github.com/webhintio/hint/commit/65d2a9a6cc52ce836c41b80b5edc3208b8d47bc9)] - Docs: Fix broken links to browser configuration (by [`Aki`](https://github.com/gesa)).
...
* [[`d75452d2e4`](https://github.com/webhintio/hint/commit/d75452d2e4af7de17b2cfe37ce4c6502495ddc25)] - Fix: Ignore prefixed properties when all browsers pass (by [`Tony Ross`](https://github.com/antross) / see also: [`#2557`](https://github.com/webhintio/hint/issues/2557)).
...
* [[`32b36d8999`](https://github.com/webhintio/hint/commit/32b36d8999902b3d9ff853da8c0960b061c383b5)] - Chore: Fix ignoring main element (by [`Tony Ross`](https://github.com/antross)).
