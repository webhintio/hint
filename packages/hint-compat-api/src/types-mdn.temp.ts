...
interface SimpleSupportStatement {
   ...
   * the array can be a just a string.
   *
...
export interface Identifier extends Partial<Record<Exclude<string, '__compat'>, CompatStatement>> {
  /**
...
export interface CompatData extends Record<Exclude<string, 'browsers'>, Identifier> {
  /**
