    ...
    * [[`ac24efaf8f`](https://github.com/webhintio/hint/commit/ac24efaf8f88fd283cad1c1e296fe9bc5c785061)] - New: Default severity for `hint-webpack-config` (see also: [`#3253`](https://github.com/webhintio/hint/issues/3253)).
    ...
    * [[`7229446cf3`](https://github.com/webhintio/hint/commit/7229446cf3ebf3cf6210f80d525569ae850e784c)] - Fix: Suppress errors when config files are not present (by [`Tony Ross`](https://github.com/antross)).
    ...
    * [[`f8cbcef837`](https://github.com/webhintio/hint/commit/f8cbcef8379fa2b97c990fbfae6a74b13a4a6c8f)] - New: Add `utils` package (by [`Jesus David García Gomez`](https://github.com/sarvaje)).
    ...
    # 2.4.28 (November 2025)
    * [[`<commit-id>`](https://github.com/webhintio/hint/commit/<commit-id>)] - Docs: Add missing changelog entry (by [YourName](https://github.com/<your-username>)).
