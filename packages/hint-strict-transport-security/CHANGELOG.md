...
* [[`a2bda0e70a`](https://github.com/webhintio/hint/commit/a2bda0e70a386c9f4ca42a7f35d43b1b70b2ba87)] - New: Default severity for `strict-transport-security` (see also: [`#3248`](https://github.com/webhintio/hint/issues/3248)).
...
* [[`e7bf36b8fc`](https://github.com/webhintio/hint/commit/e7bf36b8fc1c88bea85ceab511029932b63da528)] - Chore: Change to `serial` to pass build (by [`Antón Molleda`](https://github.com/molant)).
...
* [[`dcebd11ffa`](https://github.com/webhintio/hint/commit/dcebd11ffa76779ce4764a27bcfffdcee065f8ad)] - Fix: Validate only resources specified as `http(s)://...` (by [`Antón Molleda`](https://github.com/molant) / see also: [`#1323`](https://github.com/webhintio/hint/issues/1323)).
