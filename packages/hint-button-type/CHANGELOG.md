...
* [[`6570539bc0`](https://github.com/webhintio/hint/commit/6570539bc0c3a6eb1dcd3abffe8f8ba1020b0fc6)] - Chore: Check for 'FORM' instead of 'form' (by [`Tony Ross`](https://github.com/antross)).
...
# 2.3.0 (December 2, 2019)

## New features

* [[`46a34fff47`](https://github.com/webhintio/hint/commit/46a34fff47caf5611ca1e9fca6c502b5cde1d3f5)] - New: Default severity for `button-type` (see also: [`#3212`](https://github.com/webhintio/hint/issues/3212)).
...
# 2.2.9 (September 26, 2019)


# 2.2.8 (September 24, 2019)
...
# 2.2.5 (August 29, 2019)


# 2.2.4 (August 15, 2019)
...
* [[`c69660a501`](https://github.com/webhintio/hint/commit/c69660a501902fbd5cbd30139e4d70c40fd4d4cf)] - Docs: Update hint-button-type friendly name (by [`Tony Ross`](https://github.com/antross)).
...
* Chore: Add missing references in TypeScript configuration.
