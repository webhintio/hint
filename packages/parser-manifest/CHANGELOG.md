...
* [[`0e894bc129`](https://github.com/webhintio/hint/commit/0e894bc129872888be1313f45a113d2231f6a7b9)] - Upgrade: Bump ajv from 7.1.1 to 8.2.0 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`406a63ad53`](https://github.com/webhintio/hint/commit/406a63ad53a04be53039fc4f57288fe915eb8e79)] - New: Automatically update web manifest schema (by [`Tony Ross`](https://github.com/antross) / see also: [`#3921`](https://github.com/webhintio/hint/issues/3921)).
...
* [[`d736e18ce2`](https://github.com/webhintio/hint/commit/d736e18ce2ca5a37e150757b82429431d8cd5ec8)] - Fix: Icon purpose doesn't support combination of values (by [`Jesus David García Gomez`](https://github.com/sarvaje) / see also: [`#3791`](https://github.com/webhintio/hint/issues/3791)).
...
# 2.2.16 (March 18, 2020)

## Bug fixes / Improvements

* [[`c5eb40f819`](https://github.com/webhintio/hint/commit/c5eb40f819f79b6f92b18dcd015bfda5807bb034)] - Fix: Add `maskable` to `icon.purpose` in manifest (by [`Dimitar Nestorov`](https://github.com/dimitarnestorov) / see also: [`#3451`](https://github.com/webhintio/hint/issues/3451)).
...
* [[`78090ab816`](https://github.com/webhintio/hint/commit/78090ab816517b1cba3295a170c5e76502c73c13)] - Fix: Type definition for `ManifestPlatform` to be a string (by [`Tony Ross`](https://github.com/antross) / see also: [`#2394`](https://github.com/webhintio/hint/issues/2394)).
...
* [[`87f703e869`](https://github.com/webhintio/hint/commit/87f703e8694fe5eb30b478d804e649ea4c6dcce2)] - Upgrade: Bump ajv from 6.9.2 to 6.10.0 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`711a10fec7`](https://github.com/webhintio/hint/commit/711a10fec7f1849973e64830b905af15dc20d1bd)] - Upgrade: Bump ajv from 6.9.1 to 6.9.2 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`4f3ac11c8f`](https://github.com/webhintio/hint/commit/4f3ac11c8fbba4ce7add2db8e5c17da26ea8fba3)] - Upgrade: Bump ajv from 6.8.1 to 6.9.1 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`28cb38ada8`](https://github.com/webhintio/hint/commit/28cb38ada8b2bc27de1b5fd96cac47903a9395e3)] - Upgrade: Bump ajv from 6.7.0 to 6.8.1 (by [`Dependabot`](https://github.com/dependabot-bot)).
