...
# 3.0.4 (February 4, 2021)

## Bug fixes / Improvements

* [[`65d6975700`](https://github.com/webhintio/hint/commit/65d6975700ad135b8685098182d56c0d26a29702)] - Fix: Incorrect recommended expires date (by [`Tony Ross`](https://github.com/antross) / see also: [`#4209`](https://github.com/webhintio/hint/issues/4209)).
...
* [[`c8231975d9`](https://github.com/webhintio/hint/commit/c8231975d91261dd8dba1434a27c80ac6164452b)] - Fix: Report all cookie errors (by [`Jan Pilzer`](https://github.com/Hirse) / see also: [`#2642`](https://github.com/webhintio/hint/issues/2642)).
* [[`460a1ee91c`](https://github.com/webhintio/hint/commit/460a1ee91c89d987f938947c91babb3d18ef5a58)] - Fix: Detect invalid backslash in cookie (by [`Jan Pilzer`](https://github.com/Hirse) / see also: [`#3534`](https://github.com/webhintio/hint/issues/3534)).
...
* [[`d0777cf6e7`](https://github.com/webhintio/hint/commit/d0777cf6e7662d9b1b6b80b3899e6ccc67dcd431)] - New: Default severity for `validate-set-cookie-header` (see also: [`#3252`](https://github.com/webhintio/hint/issues/3252)).
...
* [[`12efd8a6d5`](https://github.com/webhintio/hint/commit/12efd8a6d5c437f91b8aa3aea8bed6ed9eec796c)] - Chore: Re-enable `no-insecure-cookies` tests on `puppeteer` (by [`Antón Molleda`](https://github.com/molant) / see also: [`#439`](https://github.com/webhintio/hint/issues/439)).
