...
* [[`57fafe3653`](https://github.com/webhintio/hint/commit/57fafe3653a56a8ef28d57da4ade5e64408e0df1)] - Chore: Remove unnecessary Promises in `hint-sri` (by [`Jesus David García Gomez`](https://github.com/sarvaje) / see also: [`#2035`](https://github.com/webhintio/hint/issues/2035)).
...
* [[`3279708e30`](https://github.com/webhintio/hint/commit/3279708e303de4ac30dfa092dfdd014090620686)] - New: Default severity for `sri` (see also: [`#3246`](https://github.com/webhintio/hint/issues/3246)).
...
* [[`61e764db5b`](https://github.com/webhintio/hint/commit/61e764db5bb45c80a4cce0234be58d871fbcd45c)] - Fix: Add `gzip` option to request to decompress content (by [`Jesus David García Gomez`](https://github.com/sarvaje) / see also: [`#2068`](https://github.com/webhintio/hint/issues/2068)).
