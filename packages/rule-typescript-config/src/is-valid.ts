...
export default class TypeScriptConfigIsValid implements IRule {
    ...
    public constructor(context: RuleContext) {
        ...
        const invalidJSONFile = async (typeScriptConfigInvalid: TypeScriptConfigInvalid) => {
            ...
            debug(`parser::typescript-config::error::json received`);
        ...
        const invalidSchema = async (fetchEnd: TypeScriptConfigInvalidSchema) => {
            ...
            debug(`parser::typescript-config::error::schema received`);
        ...
        context.on('parser::typescript-config::error::json', invalidJSONFile);
        context.on('parser::typescript-config::error::schema', invalidSchema);
    }
}
