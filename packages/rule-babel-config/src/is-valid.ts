...
export default class BabelConfigIsValidRule implements IRule {
    ...
    public constructor(context: RuleContext) {
        ...
        const invalidJSONFile = async (babelConfigInvalid: BabelConfigInvalid) => {
            ...
            debug(`parser::babel-config::error::json received`);
        ...
        const invalidSchema = async (fetchEnd: BabelConfigInvalidSchema) => {
            ...
            debug(`parser::babel-config::error::schema received`);
        ...
        context.on('parser::babel-config::error::json', invalidJSONFile);
        context.on('parser::babel-config::error::schema', invalidSchema);
    }
}
