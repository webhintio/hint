...
* [[`7134dac070`](https://github.com/webhintio/hint/commit/7134dac070cf6867d79c928a1c47e53064c12be5)] - Upgrade: Bump chokidar from 3.5.1 to 3.5.2 (by [`dependabot[bot]`](https://github.com/apps/dependabot)).
...
* [[`558197f530`](https://github.com/webhintio/hint/commit/558197f5309ed918799bf14f9998a7240f4ad1e8)] - Docs: Fix typo in README.md (by [`Didi Keke`](https://github.com/nyedidikeke) / see also: [`#4261`](https://github.com/webhintio/hint/issues/4261)).
...
* [[`e846f77b0a`](https://github.com/webhintio/hint/commit/e846f77b0a836ab748465552b3874c27a25fd0c0)] - Upgrade: Bump chokidar from 3.5.0 to 3.5.1 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`494a0073f0`](https://github.com/webhintio/hint/commit/494a0073f0d6730975ceaaf49899cdadd6f15cf1)] - Upgrade: Bump chokidar from 3.4.3 to 3.5.0 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`b40aa6eaf7`](https://github.com/webhintio/hint/commit/b40aa6eaf74dda5c8020da7e950ffc072ec981ff)] - Upgrade: Bump chokidar from 3.4.2 to 3.4.3 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`c52c844102`](https://github.com/webhintio/hint/commit/c52c8441023b097effed1b1f7b61e0711f0a479e)] - Upgrade: Bump chokidar from 3.3.0 to 3.3.1 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`56542567a9`](https://github.com/webhintio/hint/commit/56542567a943e5a14cec070e1fe765f77433bcf2)] - Fix: Check target is `file://` in connector-local (see also: [`#3363`](https://github.com/webhintio/hint/issues/3363)).
...
* [[`a4a056d234`](https://github.com/webhintio/hint/commit/a4a056d234e5002561385ce8c98fa4d7d2379ac5)] - Upgrade: Bump chokidar from 3.2.3 to 3.3.0.
...
* [[`711b849d55`](https://github.com/webhintio/hint/commit/711b849d559d296e42376b61b6b3388bfadc847c)] - Upgrade: Bump chokidar from 3.0.2 to 3.2.3.


# 3.2.0 (October 29, 2019)
...
* [[`0278888e1e`](https://github.com/webhintio/hint/commit/0278888e1e07950ece3f0a9f75fee568cd6c33ba)] - Chore: Fix build failures due to `globby` type updates (by [`Tony Ross`](https://github.com/antross)).
...
* [[`e8e845ab53`](https://github.com/webhintio/hint/commit/e8e845ab53f220ebba21db4029232df487a1707e)] - Upgrade: Bump chokidar from 3.0.1 to 3.0.2 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`1847288780`](https://github.com/webhintio/hint/commit/1847288780960f4af6125ca79728e2d40a0529af)] - Upgrade: Bump chokidar from 3.0.0 to 3.0.1 (by [`dependabot-preview[bot]`](https://github.com/apps/dependabot-preview)).
...
* [[`61c95efcf4`](https://github.com/webhintio/hint/commit/61c95efcf4745570842e0752484111ac205f48a1)] - Breaking: Add a `schema` property for validation (by [`Antón Molleda`](https://github.com/molant) / see also: [`#2257`](https://github.com/webhintio/hint/issues/2257)).
...
* [[`d6e8c21f9b`](https://github.com/webhintio/hint/commit/d6e8c21f9bd08fa993739b6c3d66ad9f89a1d09a)] - Fix: Change how traversing and evaluate is done (by [`Jesus David García Gomez`](https://github.com/sarvaje)).
...
* [[`3bd5ea8f3d`](https://github.com/webhintio/hint/commit/3bd5ea8f3ddb9d88b78efa38b3dd34f465cec5f3)] - Upgrade: Bump chokidar from 2.1.5 to 3.0.0 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`0c862603a3`](https://github.com/webhintio/hint/commit/0c862603a37dda6b6cc78d902d9805b7c36ce967)] - Upgrade: Bump jsdom from 14.0.0 to 15.0.0 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`11cf4ed767`](https://github.com/webhintio/hint/commit/11cf4ed7674bc4aaba1c2624b2529d90f3d9a626)] - Upgrade: Bump chokidar from 2.1.4 to 2.1.5 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`f7006b47f0`](https://github.com/webhintio/hint/commit/f7006b47f0d19f0e6c661f92a0e7eb5026cb775e)] - Upgrade: Bump chokidar from 2.1.2 to 2.1.4 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`06ebaf8bf5`](https://github.com/webhintio/hint/commit/06ebaf8bf548b415401ea3aaf6acf6bfa69dbb5b)] - Upgrade: Bump jsdom from 13.2.0 to 14.0.0 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`382ed2b52a`](https://github.com/webhintio/hint/commit/382ed2b52a3e4901e28931d1329e2e98283f48c9)] - Upgrade: Bump @types/chokidar from 1.7.5 to 2.1.3 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`62df2451d6`](https://github.com/webhintio/hint/commit/62df2451d64ecaea43325dafad7c5765bbc31273)] - Upgrade: Bump globby from 9.0.0 to 9.1.0 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`dc49069ed3`](https://github.com/webhintio/hint/commit/dc49069ed33036d10d6e913f244853036fecbe50)] - Upgrade: Bump chokidar from 2.1.1 to 2.1.2 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`55a7e06042`](https://github.com/webhintio/hint/commit/55a7e06042ea724ef83632eb1c7ab42bcb8a99d6)] - Upgrade: Bump chokidar from 2.1.0 to 2.1.1 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`deb2b8b28e`](https://github.com/webhintio/hint/commit/deb2b8b28ea6b555b8f0909a53cbfb5ea227c037)] - Upgrade: Bump chokidar from 2.0.4 to 2.1.0 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`2abb2bb658`](https://github.com/webhintio/hint/commit/2abb2bb65897d1d52e2203a60555a3c855c458e7)] - Upgrade: Bump mock-require from 3.0.2 to 3.0.3 (by [`Dependabot`](https://github.com/dependabot-bot)).
...
* [[`00cd71c463`](https://github.com/webhintio/hint/commit/00cd71c46334bce871e1457de2c71bf2ce282207)] - Upgrade: Bump globby from 8.0.1 to 9.0.0 (by [`Dependabot`](https://github.com/dependabot-bot)).
